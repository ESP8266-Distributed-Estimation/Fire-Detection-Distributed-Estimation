...
*   **Device:** **ESP32** (Battery Powered). *(Changed from Pico W for ESP-NOW stability).*
...
*   **End Nodes (ESP32):** C++ / Arduino Framework.
    *   Lib: `esp_now.h`, `WiFi.h`.
*   **Edge Nodes (ESP32):** C++ / Arduino Framework.
    *   Lib: `esp_now.h`, `PubSubClient` (MQTT).
*   **Backend (Server):** Go (Golang).
    *   Lib: `paho.mqtt.golang`.

---

## 6. Project References & Links

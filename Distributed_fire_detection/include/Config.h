...
#define ALARM_TIMEOUT_MS                                                       \
  8000 // Expire propagated alarm after 8 seconds of no updates
#define ALARM_FORGET_MS                                                        \
  20000 // Completely forget sequence numbers after 20s to prevent zombie echoes

...
// --- MQTT Configuration ---
#define MQTT_SERVER "Your_MQTT_Server" // Updated to laptop's IP
...
#define MQTT_TOPIC_COMMAND_PREFIX "fire_alarm/command/" // + EDGE_NODE_ID
#define MQTT_TOPIC_SCHEME_ACK "fire_alarm/scheme_ack"

// --- System Configuration ---
#define STATUS_INTERVAL_MS                                                     \
  10000 // How often the edge node pings MQTT that it's alive
#define MAX_ACTIVE_ALARMS 20 // Size of the de-duplication cache
#define NODE_TIMEOUT_MS                                                        \
  10000 // Remove sensor node if no packet received in 10 seconds
